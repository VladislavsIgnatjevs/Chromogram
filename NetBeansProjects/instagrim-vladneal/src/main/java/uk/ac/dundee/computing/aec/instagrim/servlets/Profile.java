...
/**
 * Designed to handle show_profile.jsp requests
 *
...
public class Profile extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (command) {
            case 1:
                viewProfile(args[2], request, response);
                break;
            default:
    ...
    private void viewProfile(String login, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        User user = new User();
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/show_profile.jsp");
